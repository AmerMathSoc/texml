package TeX::Interpreter::LaTeX::Class::ert_l;
...
\ProvidesClass{ert-l}[2007/06/18 v2.02 Representation Theory Document Class]
...
\gdef\AMS@publkey{ert}

\def\AMS@publname{Representation Theory}
\def\AMS@publname@short{Represent. Theory}
