package TeX::Interpreter::LaTeX::Class::proc_l;
...
sub install ( $ ) {
    ...
    $tex->read_package_data(*TeX::Interpreter::LaTeX::Class::proc_l::DATA{IO});
...
\def\AMS@publname{Proceedings of the American Mathematical Society}
