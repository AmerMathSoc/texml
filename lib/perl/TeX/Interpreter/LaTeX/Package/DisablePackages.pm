...
\DisablePackage{thm_listof}
\DisablePackage{tikz_3dplot}
\DisablePackage{tikz_base}
\DisablePackage{tikz_fct}
\DisablePackage{tkz_graph}
\DisablePackage{tikz_qtree_compat}
\DisablePackage{tkz_euclide}
